#!/home/wl/.conda/envs/torch1.10/bin/python
...
#sys.path.remove('/home/wl/catkin_ws/install_isolated/lib/python2.7/dist-packages')
...
def rescale(ori_shape, boxes, target_shape):
    ...
    boxes[:, 1].clamp_(0, target_shape[0])  # y1  # /usr/bin/python3
