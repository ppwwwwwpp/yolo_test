...
void YOLO::yoloConfig(Net_config &config)
{
	...
	string classesFile = "/home/wl/test_ws/swarm_ws/src/rosvino/models/class.names";
	//string model_path = "/home/wl/test_ws/darknet/src/yolov7-ros/weights/best-rotate.onnx";
        string model_path = "/home/wl/test_ws/darknet/src/yolov7-ros/weights/rotate_ref_best.onnx";
	std::wstring widestr = std::wstring(model_path.begin(), model_path.end());
	//OrtStatus* status = OrtSessionOptionsAppendExecutionProvider_CUDA(sessionOptions, 0);

        sessionOptions.SetInterOpNumThreads(1);
        //sessionOptions.execution_mode = ort.ExecutionMode.ORT_PARALLEL;
...
//        yoloConfig(yolo_nets);
	...
	for (size_t i = 0; i < generate_boxes.size(); ++i)
	{
		...
		putText(frame, label, Point(xmin, ymin - 5), FONT_HERSHEY_SIMPLEX, 0.75, Scalar(0, 255, 0), 1);
                ...
                printf("Confidence: %s %d %d %d %d %d\n", label, xmin, ymin, rectInput.size.width, rectInput.size.height, rectInput.angle);
	}
}
