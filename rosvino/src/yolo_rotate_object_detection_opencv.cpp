...
YOLO::YOLO(Net_config config)
{
	...
	string modelFile = "/home/wl/test_ws/darknet/src/yolov7-ros/weights/best-rotate.onnx";
	//this->net = dnn::readNet(modelFile);
	this->net = cv::dnn::readNetFromONNX(modelFile);
        //this->net = readNetFromONNX(modelFile); //.c_str()
	ifstream ifs("/home/wl/test_ws/swarm_ws/src/rosvino/models/class.names");
	string line;
